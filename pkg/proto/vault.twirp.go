...
// NewVaultProtobufClient creates a Protobuf client that implements the Vault interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewVaultProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Vault {
...
func (c *vaultProtobufClient) GetConfig(ctx context.Context, in *google_protobuf.Empty) (*AuthConfigResponse, error) {
	...
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *google_protobuf.Empty) (*AuthConfigResponse, error) {
			...
			if resp != nil {
				typedResp, ok := resp.(*AuthConfigResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*AuthConfigResponse) when calling interceptor")
				}
...
func (c *vaultProtobufClient) callGetConfig(ctx context.Context, in *google_protobuf.Empty) (*AuthConfigResponse, error) {
...
// NewVaultJSONClient creates a JSON client that implements the Vault interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewVaultJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Vault {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *vaultJSONClient) GetConfig(ctx context.Context, in *google_protobuf.Empty) (*AuthConfigResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "vault")
	ctx = ctxsetters.WithServiceName(ctx, "Vault")
	ctx = ctxsetters.WithMethodName(ctx, "GetConfig")
	caller := c.callGetConfig
...
// NewVaultServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewVaultServer(svc Vault, opts ...interface{}) TwirpServer {
...
func (s *vaultServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// handleRequestBodyError is used to handle error when the twirp server cannot read request
func (s *vaultServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// VaultPathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const VaultPathPrefix = "/twirp/vault.Vault/"

func (s *vaultServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "vault")
	ctx = ctxsetters.WithServiceName(ctx, "Vault")
...
func (s *vaultServer) serveGetConfig(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *vaultServer) serveGetConfigJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetConfig")
	...
	handler := s.Vault.GetConfig
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *google_protobuf.Empty) (*AuthConfigResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Vault.GetConfig(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*AuthConfigResponse)
	...
	// Call service method
	var respContent *AuthConfigResponse
	func() {
...
func (s *vaultServer) serveGetConfigProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetConfig")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *vaultServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *vaultServer) ProtocGenTwirpVersion() string {
	return "v8.1.2"
}
...
func (s *vaultServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "vault", "Vault")
}
